...
const cachTypes = ["audio/mpeg", "text/css", "image/png", "image/gif", "image/x-icon", "image/svg+xml" , "image/jpeg", "font/woff", "font/woff2", "font/otf", "font/eot", "font/ttf", "application/json"]
const cachOptions = {
